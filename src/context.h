...
#define DEFAULT_ZERO_THRESHOLD 5.0e-2
#define DEFAULT_GEOMETRY_THRESHOLD 5.0e-2
#define DEFAULT_ANGLE_THRESHOLD 5.0e-2
#define DEFAULT_EQUIVALENCE_THRESHOLD 5.0e-2
#define DEFAULT_EIGFACT_THRESHOLD 1.0e-2
#define DEFAULT_PERMUTATION_THRESHOLD 5.0e-2
